...
author = 'Stephen Jesse, Suhas Somnath and Chris Smith'
...
latex_documents = [
    (master_doc, 'USID.tex', 'USID Documentation',
     'Stephen Jesse, Suhas Somnath and Chris Smith', 'manual'),
]
...
man_pages = [
    (master_doc, 'usid', 'USID Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'USID', 'USID Documentation',
     author, 'USID', 'Universal Spectroscopy and Imaging Data (USID)',
     'Miscellaneous'),
]
